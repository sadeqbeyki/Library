...
namespace Warehouse.Persistance.Repositories
{
    public class InventoryRepository : Repository<Inventory, int>, IInventoryRepository
    {
        ...
        public InventoryRepository(InventoryDbContext inventoryDbContext, BookDbContext bookDbContext,
            AppIdentityDbContext identityDbContext) : base(inventoryDbContext)
        {
